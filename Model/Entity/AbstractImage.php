...
abstract class AbstractImage {
	...
	public function upload(){
		...
		$this->postCrop($image);
		$image->save($this->getImageAbsolutePath());

	}

	/**
	 * You can overide this method for manage the image before
	 * the crop.
	 * 
	 * @param GregwarImage $image
	 */
	protected function preCrop(GregwarImage $image){
		return;
	}


	/**
	 * You can overide this one for manage the image after the crop
	 * 
	 * @param GregwarImage $image
	 */
	public function postCrop(GregwarImage $image){
		return;
	}
}